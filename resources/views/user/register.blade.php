          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="/user/register" method="post">
                ...
                <div class="pb-8">
                    ...
                    @if ($errors->any())
                    <p class="bg-red-500 p-2">Something went wrong</p>
                    <div class=" border-red-500 border-y-2 border-x-2 p-3">
                        <ul>
